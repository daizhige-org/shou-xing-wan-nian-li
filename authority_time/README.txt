...
This archive contains the current snapshot of the DDBC Time Authority
database, as of October, 2010, including full data for the Chinese,
Japanese and Korean Dynastic calendars.
...
* `authority_time.sql`
   ...
   and relations properly arranged.
